...
let doublefetch = fetch(`http://localhost/COMS/AssocClient/Functions/GetDocument.php?action=getDocumentDetails`)
...
.then(data => {
    ...
    return fetch("http://localhost/COMS/AssocClient/Functions/Querries/InfromationManagement.php?action=checkReciptient");
})
.then(response=> response.json())
.catch(error => console.error('Error:', error));

doublefetch.then(currentUser=>{
    Recpt.forEach((dt)=>{
        console.log(dt);
