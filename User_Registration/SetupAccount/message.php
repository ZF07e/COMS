...
<html lang="en">
    <head>
        ...
        <title>COMS: Confirm Account</title>
            ...
            <div class="form animate--fadeIn delay-3">
                <section class="middlesection">
                    ...
                    <div class="messageContainer">
                        <div class="imgContainer">
                            <img src="../../Images/Icons/icons8-check-50.png" alt="Picture" class="">
                            <h2>COMS</h2>
                        </div>               
                ...
                <section class="bottomsection">
                    <div class="buttonContainer">
                        <button class="submit-data animate--fadeIn delay-1">Proceed.</button>
                    </div>
                </section>
            </div>
        </main>
        <script type="module" src="../Scripts/setupData/data.js"></script>
    </body>
</html>